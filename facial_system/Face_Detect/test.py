...
if __name__ == '__main__':
    ...
    for im in paths[:5000]:
        ...
        # ignore low scores
        inds = np.where(scores > float(args.confidence_threshold))[0]
        boxes = boxes[inds]
        landms = landms[inds]
        scores = scores[inds]
        ...
        if args.save_image:
            ...
            # save image
                ...
                try:
                    ...
                    pass
                cv2.imwrite("/home/cyber/Hung/test_face/"+ str(random.getrandbits(128)) +".jpg", face_img)
                #time.sleep(1)
